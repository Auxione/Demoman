...
public class Tileset {
	...
	public static void InitTileset() {
		createTile(0, "Empty", true, false, 0, false, Constants.empty, false);

		createTile(1, "grass", true, true, 5000, true, Constants.grass, true);

		createTile(2, "wood", true, true, 2000, true, Constants.wood, false);

		createTile(3, "rock", true, true, 3000, false, Constants.rock, false);
		createTile(4, "Brickwall", false, false, 4000, false, Constants.brick, false);
		createTile(5, "metalframe", false, true, 5000, false, Constants.metalframe, false);

		createTile(6, "farmLand", true, true, 5000, true, Constants.Farmland, true);
	}
