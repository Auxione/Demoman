...
public class Functions {
	...
	public static boolean lineToLineIntersectionBool(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
...
//this function returns coordinates of the intersection
	public static float[] lineToLineIntersectionCord(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
		float uA = ((x4 - x3) * (y1 - y3) - (y4 - y3) * (x1 - x3)) / ((y4 - y3) * (x2 - x1) - (x4 - x3) * (y2 - y1));
		float uB = ((x2 - x1) * (y1 - y3) - (y2 - y1) * (x1 - x3)) / ((y4 - y3) * (x2 - x1) - (x4 - x3) * (y2 - y1));
