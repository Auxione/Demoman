...
public class EditorSetup {
	...
	public EditorSetup(Console console) {
		this.mapSizeXInputBox = new Inputbox(20, 20, 200, 50, "Size x: ", 1);
		this.mapSizeYInputBox = new Inputbox(20, 80, 200, 50, "Size y: ", 1);
		this.mapSizeXInputBox.setCompleteWhenFocusLoss(true);
		this.mapSizeYInputBox.setCompleteWhenFocusLoss(true);

		this.startGameButton = new Button(20, 140, 200, 50, "Run");
		this.backButton = new Button(20, 200, 200, 50, "Back");

		this.console = console;
		this.console.Add(0, "Editor setup");
	}
